...
<?= $this->section('content') ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <?= form_open_multipart('respon/create') ?>
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown($kelengkapan, $opt_kelengkapan, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Estimasi Pengiriman", "estimasi pengiriman") ?>
                            <?= form_dropdown($estimasi_pengiriman, $opt_estimasi_pengiriman, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("User Experience", "user experience") ?>
                            <?= form_dropdown($user_experience, $opt_user_experience, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Respon Pelayanan", "respon pelayanan") ?>
                            <?= form_dropdown($respon_pelayanan, $opt_respon_pelayanan, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Metode Pembayaran", "metode pembayaran") ?>
                            <?= form_dropdown($metode_pembayaran, $opt_metode_pembayaran, 'large'); ?>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <?= form_label("Kemudahan Fitur", "kemudahan fitur") ?>
                            <?= form_dropdown($kemudahan_fitur, $opt_kemudahan_fitur, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Kepercayaan", "kepercayaan") ?>
                            <?= form_dropdown($kepercayaan, $opt_kepercayaan, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Penanganan Komplain", "penanganan komplain") ?>
                            <?= form_dropdown($penanganan_komplain, $opt_penanganan_komplain, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Cashback", "cashback") ?>
                            <?= form_dropdown($cashback, $opt_cashback, 'large'); ?>
                        </div>
                        <div class="form-group">
                            <?= form_label("Pengiriman", "pengiriman") ?>
                            <?= form_dropdown($pengiriman, $opt_pengiriman, 'large'); ?>
                        </div>
